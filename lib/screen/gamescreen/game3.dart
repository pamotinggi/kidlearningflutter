...
class _Game3State extends State<Game3> {
  ...
  initGame() {
    ...
    score = 0;
    items = [
      ItemModel(icon: FontAwesomeIcons.fire, name: "fire", value: "fire"),
      ItemModel(name: "tree", value: "tree", icon: FontAwesomeIcons.tree),
      ItemModel(
          name: "feather", value: "feather", icon: FontAwesomeIcons.feather),
      ItemModel(name: "bug", value: "bug", icon: FontAwesomeIcons.bug),
      ItemModel(
          name: "volcano", value: "volcano", icon: FontAwesomeIcons.volcano),
    ];
